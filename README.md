...
### 实验1：大气探测极限（美国标准大气模型）         一组垂直探测，一组水平探测
...
- 场景二：  薄云层  激光雷达比不同   α = 0.1 km⁻¹，β=0.1/20 k¹sr⁻¹  一公里厚，从5km依次后移，步长500m，评估信噪比低于3   （垂直和水平两种模式）  低空一公里厚气溶胶层 0.3km⁻¹
...
- 场景设想： 参考实验1，修改累计脉冲个数，依次改为60s，30s，15s 10s 5s 3s 1s  重复实验一，评估探测距离的变化
- 动态参数：
- 评估指标（待补充）：
- 雷达仿真代码需要更改

### 实验5：补充几个特殊事件的仿真信号图，沙尘事件， 雾霾事件，从cams得出    sbdart 输出变化 导入 实验5
- 场景设想： 
- 动态参数：
- 评估指标
- 雷达仿真代码需要更改
